...
if __name__ == '__main__':
    ...
    for i in range(3):
        if i<10:
            fusionpath = 'result/' + basepath + '/F9_0'+str(i) + '.bmp'
        else: 
            fusionpath = 'result/'+ basepath + '/F9_'+str(i) + '.bmp'
        sourceVIpath = '../../Medical/Test_vi/' + str(i+1) + '.bmp'
        sourceIRpath = '../../Medical/Test_ir/' + str(i+1) + '.bmp'
    ...
    with open('record.txt','a') as f:
        ...
        f.write('mi:'+ str(mi) +'\n')
        f.write('mg'+ str(mg) +'\n')
        f.write('qabf:' + str(qabf) +'\n')
    # print('SF:',spatialF(image))

# epoch0_0114_0
# en: 7.211298612994462
# sf: 0.11
# mi: 0.7450031788906243
# mg: 0.04933333333333333
# qabf: 0.12685424528561626